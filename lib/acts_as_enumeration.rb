...
module ActsAsEnumeration
  module MacroMethods
    ...
    # used to uniquely reference a particular identifier. See ActsAsEnumeration
    ...
    def acts_as_enumeration(attribute = :name)
      ...
      extend ActsAsEnumeration::ClassMethods
      include ActsAsEnumeration::InstanceMethods
...
ActiveRecord::Base.class_eval do
  extend ActsAsEnumeration::MacroMethods
end
